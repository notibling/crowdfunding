...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-32 overflow-hidden">
      ...
      <SectionBackground 
        url="/images/screenshots/BlingNews.avif" 
        animated={true} 
        blur={true} 
        opacity="high" 
      ...
      {/* Gradiente de profundidad extra para Hero */}
      <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-white dark:from-[#020617] via-white/50 dark:via-[#0f172a]/55 to-white dark:to-[#020617]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <motion.h1
          {...fadeUp(0.5)}
          className="font-serif text-shadow-xl text-4xl md:text-6xl text-slate-900 dark:text-white leading-[0.95] tracking-tight mb-4"
        ...
        <motion.p
          {...fadeUp(0.8)}
          className="text-slate-900 dark:text-white/70 font-light leading-[1.9] max-w-xl mx-auto mb-0"
        ...
        >
          <a
            href="#colaborar"
            className="inline-flex items-center gap-2.5 bg-[#FFCC00] text-slate-900 dark:text-[#020617] font-semibold text-xs tracking-[0.2em] uppercase px-9 py-4 transition-all duration-300 hover:bg-[#ffe033] hover:translate-y-[-1px] group"
            style={{
          ...
          <a
            href="#historia"
            className="text-slate-900 dark:text-white/40 hover:text-[#FFCC00] font-medium text-[11px] tracking-[0.2em] uppercase transition-colors duration-200 border-b border-slate-300 dark:border-white/15 hover:border-[#FFCC00]/40 pb-0.5"
          >
            Nuestra historia
          </a>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <span className="text-[10px] text-slate-700 dark:text-slate-300 font-medium uppercase tracking-[0.2em]">Desarrollo</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-[10px] text-slate-700 dark:text-slate-300 font-medium uppercase tracking-[0.2em]">Ecosistema</span>
          </div>
          <div className="hidden md:block w-px h-8 bg-slate-200 dark:bg-white/10" />
          <div className="flex flex-col items-center">
            <span className="text-[#FFCC00] text-xl md:text-3xl font-bold tracking-tight mb-1">2026 Meta</span>
            <span className="text-[10px] text-slate-700 dark:text-slate-300 font-medium uppercase tracking-[0.2em]">Lanzamiento</span>
          </div>
        </motion.div>
      </div>
