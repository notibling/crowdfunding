  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-slate-50 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-300 dark:border-white/10 rounded-2xl p-3 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 pl-2">
              <div className="w-8 h-8 rounded-full bg-[#FFCC00]/10 flex items-center justify-center text-[#FFCC00]">
                <Heart size={16} fill="currentColor" />
              </div>
              <div className="hidden sm:block">
                <p className="text-slate-900 dark:text-white text-[10px] font-black uppercase tracking-widest leading-none mb-1">
                  Apoyá a Bling
                </p>
                <p className="text-slate-600 dark:text-slate-400 text-[9px] font-bold uppercase tracking-tighter leading-none">
