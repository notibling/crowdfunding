...
import { Youtube, Twitter, Facebook, Instagram, Mail, ChevronRight, X, ZoomIn, ArrowLeft, ArrowRight, Maximize2, ShieldCheck, Copy, CheckCircle2, EyeOff, Globe, ExternalLink } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="text-white"> Vos elegís cómo aparecer.</span>
          </p>
        </div>
